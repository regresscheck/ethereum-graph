...
function pruningFunction(a, b) {
    return Math.log1p(b.score) + b.connections - 100 * (b.connections === 0) + b.blockNumber - b.biggestNeighbor.connections * 0.1
        - Math.log1p(a.score) - a.connections + 100 * (b.connections === 0) - a.blockNumber + a.biggestNeighbor.connections * 0.1;
}
